...
public class Main {
    private static final String  NICKS_DUMMY_DATA_URL = "http://data.fixer.io/api/";
    ...
    public static void main(String[] args) throws IOException {
        ExchangeRateReader exchangeRateReader = new ExchangeRateReader(NICKS_DUMMY_DATA_URL);
